    ...
    <div className='register'>
      <div className='register-container'>
        ...
        <form className='register-form' onSubmit={handleSubmit}>
          ...
          <label>Senha</label>
          <input type='password' requiredonChange={event => setPassword(event.target.value)}/>
          ...
          <div className='terms'>
            ...
            <label>Eu concordo com os termos do <a href='https://www.epicgames.com/site/pt-BR/tos?lang=pt-BR'>Acordo de usuário da conta Epic Games</a> e confirmo que li a <a href='https://www.epicgames.com/site/pt-BR/tos?lang=pt-BR'>Política de privacidade da Epic Games</a>.</label>
          </div>
